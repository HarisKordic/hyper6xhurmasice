...
import { BadgeCheck, Globe2, Home, Leaf, LineChart, Users } from "lucide-react"
...
import { Area, AreaChart, Bar, BarChart, CartesianGrid, ResponsiveContainer, XAxis, YAxis } from "@/components/ui/chart"
                ...
                <div className="flex flex-col h-full">
                    <div className="p-6">
                        ...
                        <nav className="space-y-2">
                            <Link
                                href="#"
                                className="flex items-center gap-3 rounded-lg bg-secondary/80 px-3 py-2 text-secondary-foreground transition-colors hover:bg-secondary"
                            >
