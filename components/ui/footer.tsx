...
export default function Footer() {
    ...
    return (
        <footer className="absolute bottom-0 left-0 right-0 w-full border-t bg-background pl-3 pr-3">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Empowering individuals and businesses to track and reduce their environmental impact for a more
                            sustainable future.
                        </p>
                    </div>
