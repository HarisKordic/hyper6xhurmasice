        ...
        <div className="grid gap-8 grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground text-center md:text-left">
              Empowering individuals and businesses to track and reduce their
              environmental impact for a more sustainable future.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foregroun text-center md:text-left">
              Subscribe to our newsletter for the latest sustainability tips and
              updates.
            </p>
            <form
