  ...
  <div className="w-full bg-background">
   <div className="flex-1 py-4 w-full">
    <Card className="flex flex-col border-0 shadow-none">
     ...
     <div className="md:hidden max-h-[480px] overflow-y-auto hide-scrollbar">
      <AnimatePresence initial={false} mode="wait">
       {paginatedUsers.map((user, index) => (
        <motion.div
         key={user.id}
          ...
          <CardContent className="p-4">
           <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
             <span className="font-medium">#{(currentPage - 1) * ITEMS_PER_PAGE + index + 1}</span>
           ...
           <div className="space-y-3">
            <div className="flex justify-between items-center">
             ...
             <span className="text-green-500">-{user.carbonReduction}%</span>
            </div>
